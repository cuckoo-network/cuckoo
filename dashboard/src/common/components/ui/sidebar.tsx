  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // The negative margin pulls a collapsed label over the preceding
        // group's final menu button. Keep that invisible box out of pointer
        // hit-testing so the icon beneath it remains clickable.
