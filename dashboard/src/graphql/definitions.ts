...
export type EnvironmentFieldsFragment = { __typename: 'Environment', id: string | null, projectId: string | null, name: string | null, ownerId: string | null, createdAt: string | null, serviceIds: Array<string | null> | null };
