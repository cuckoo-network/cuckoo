...
export type CreateServiceMutation = { createService: { __typename: 'Service', id: string | null, name: string | null, type: string | null, phase: string | null, projectId: string | null, environmentId: string | null, registryCredentialId: string | null } | null };
