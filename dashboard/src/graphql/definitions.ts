...
export type DeployQuery = { deploy: { __typename: 'Deploy', id: string | null, status: string | null, trigger: string | null, image: string | null, rollbackOf: string | null, createdAt: string | null, startedAt: string | null, finishedAt: string | null, preDeployStatus: string | null } | null };
