...
export type DeployQuery = { deploy: { __typename: 'Deploy', id: string | null, status: string | null, trigger: string | null, image: string | null, rollbackOf: string | null, commitId: string | null, commitMessage: string | null, createdAt: string | null, updatedAt: string | null, startedAt: string | null, finishedAt: string | null, preDeployStatus: string | null } | null };
...
export type DeploysQuery = { deploys: Array<{ __typename: 'Deploy', id: string | null, status: string | null, trigger: string | null, image: string | null, rollbackOf: string | null, commitId: string | null, commitMessage: string | null, createdAt: string | null, updatedAt: string | null, startedAt: string | null, finishedAt: string | null, preDeployStatus: string | null } | null> | null };
