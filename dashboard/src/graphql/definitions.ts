...
export type ProjectsQuery = { projects: Array<{ __typename: 'Project', id: string | null, name: string | null, ownerId: string | null, createdAt: string | null, serviceIds: Array<string | null> | null } | null> | null };

export type CreateProjectMutationVariables = Exact<{ name: Scalars['String']['input']; ownerId: Scalars['String']['input'] }>;
export type CreateProjectMutation = { createProject: { __typename: 'Project', id: string | null, name: string | null, ownerId: string | null, createdAt: string | null, serviceIds: Array<string | null> | null } | null };

export type RenameProjectMutationVariables = Exact<{ id: Scalars['String']['input']; name: Scalars['String']['input'] }>;
export type RenameProjectMutation = { renameProject: { __typename: 'Project', id: string | null, name: string | null, ownerId: string | null, createdAt: string | null, serviceIds: Array<string | null> | null } | null };
...
export type SetProjectServicesMutation = { setProjectServices: { __typename: 'Project', id: string | null, name: string | null, ownerId: string | null, createdAt: string | null, serviceIds: Array<string | null> | null } | null };

const projectFields = [{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"ownerId"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"serviceIds"}}];
