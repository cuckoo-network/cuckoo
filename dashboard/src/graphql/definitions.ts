...
export type ApiKeysQueryVariables = Exact<{ ownerId?: InputMaybe<Scalars['String']['input']>; }>;
...
export type UsageQueryVariables = Exact<{ period?: InputMaybe<Scalars['String']['input']>; ownerId?: InputMaybe<Scalars['String']['input']>; }>;
