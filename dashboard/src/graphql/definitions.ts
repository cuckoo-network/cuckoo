...
export type UsageQuery = { usage: { __typename: 'UsageSummary', workspaceId: string | null, period: string | null, services: Array<{ __typename: 'ServiceUsage', serviceId: string | null, serviceName: string | null, resourceKind: string | null, rows: Array<{ __typename: 'UsageRow', kind: string | null, tier: string | null, total: number | null } | null> | null } | null> | null, estimatedCost: { __typename: 'EstimatedCost', totalUsd: string | null, meters: Array<{ __typename: 'MeterEstimate', kind: string | null, tier: string | null, resourceKind: string | null, costUsd: string | null } | null> | null } | null, billing: { __typename: 'Billing', currentCost: { __typename: 'BillingAmount', amountUsd: string | null, currency: string | null, periodStart: string | null, periodEnd: string | null } | null, invoices: Array<{ __typename: 'BillingInvoice', id: string | null, status: string | null, amountUsd: string | null, currency: string | null, periodStart: string | null, periodEnd: string | null } | null> | null } | null } | null };
