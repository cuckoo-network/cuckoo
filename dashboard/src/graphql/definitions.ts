...
export type AgentSessionConfig = {
  ...
  openPr: Maybe<Scalars['Boolean']['output']>;
...
export type AgentSessionConfigInput = {
  ...
  openPr?: InputMaybe<Scalars['Boolean']['input']>;
...
export type AgentSessionFieldsFragment = { __typename: 'AgentSession', id: string, ownerId: string, repo: string, branch: string, sandboxId: string | null, sshAddress: string | null, phase: string, status: string, headSha: string | null, prUrl: string | null, prNumber: number | null, turns: number | null, deliveryMode: string | null, failureReason: string | null, createdAt: string, updatedAt: string, canceledAt: string | null, agentConfig: { __typename: 'AgentSessionConfig', agent: string, model: string | null, modelEndpoint: string | null, task: string, template: string | null, openPr: boolean | null } };
...
export type AgentSessionQuery = { agentSession: { __typename: 'AgentSession', id: string, ownerId: string, repo: string, branch: string, sandboxId: string | null, sshAddress: string | null, phase: string, status: string, headSha: string | null, prUrl: string | null, prNumber: number | null, turns: number | null, deliveryMode: string | null, failureReason: string | null, createdAt: string, updatedAt: string, canceledAt: string | null, agentConfig: { __typename: 'AgentSessionConfig', agent: string, model: string | null, modelEndpoint: string | null, task: string, template: string | null, openPr: boolean | null } } | null };
...
export type CreateAgentSessionMutation = { createAgentSession: { __typename: 'AgentSession', id: string, ownerId: string, repo: string, branch: string, sandboxId: string | null, sshAddress: string | null, phase: string, status: string, headSha: string | null, prUrl: string | null, prNumber: number | null, turns: number | null, deliveryMode: string | null, failureReason: string | null, createdAt: string, updatedAt: string, canceledAt: string | null, ticket: string | null, url: string | null, expiresAt: string | null, agentConfig: { __typename: 'AgentSessionConfig', agent: string, model: string | null, modelEndpoint: string | null, task: string, template: string | null, openPr: boolean | null } } | null };
