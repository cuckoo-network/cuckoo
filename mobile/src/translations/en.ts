export const en = {
  ...
  agentSessions: {
    ...
    composer: {
      ...
      repoPickerConfirm: "Use repository",
      searchRepos: "Search repositories",
      clearRepoSearch: "Clear repository search",
      noRepoMatches: "No matching repositories.",
      branch: "Branch",
      agent: "Agent",
      autoAgent: "Auto",
      prompt: "Task",
      ...
      submit: "Assign task",
      createFailed: "Couldn't create the session. Try again.",
    ...
    detail: {
      ...
      failure: "Failure",
      failureUnknown: "The agent session ended with an error.",
    ...
    conversation: {
      ...
      unavailable:
        "Live conversation is unavailable. Session status and results remain available below.",
      you: "You",
      agent: "Agent",
      ...
      noOutput: "No output",
      unknownPart: "Unsupported activity: %{type}",
    },
    steering: {
      title: "Follow up",
      placeholder: "Send a follow-up instruction…",
      send: "Send follow-up",
      offline: "Reconnect to send a follow-up.",
      reconnecting: "Reconnecting to the session…",
      pending: "Waiting for the current turn to finish…",
      unknown:
        "The turn result is uncertain. Refresh the durable conversation before sending it again.",
    },
    decision: {
      title: "Agent needs your input",
      turnExpires: "This request expires at %{time}.",
      onceOnly:
        "Only this one action is approved; no persistent permission is granted.",
      decline: "Decline",
      submit: "Submit response",
      openLink: "Open secure link",
      complete: "I've finished",
      invalid: "Complete the required fields with valid values.",
      changed:
        "This request changed or was already answered. Refresh and review it again.",
      unsupported: "This request cannot be answered safely on mobile.",
      sensitiveUnsupported:
        "Sensitive values must be entered through a secure external link, not in the conversation.",
    },
  },
  auth: {
