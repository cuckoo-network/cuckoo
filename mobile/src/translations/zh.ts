export const zh = {
  ...
  agentSessions: {
    ...
    composer: {
      ...
      repo: "代码仓库",
      chooseRepo: "选择代码仓库",
      repoPickerConfirm: "选用仓库",
      searchRepos: "搜索代码仓库",
      clearRepoSearch: "清除仓库搜索",
      noRepoMatches: "没有匹配的代码仓库。",
      branch: "分支",
      agent: "智能体",
      autoAgent: "自动",
      prompt: "任务",
      promptPlaceholder: "想做什么？",
      submit: "分派任务",
    ...
    conversation: {
      ...
      empty: "还没有对话内容。",
      streaming: "智能体正在工作……",
      unavailable: "实时对话当前不可用。你仍可在下方查看会话状态和结果。",
      you: "你",
      agent: "智能体",
      userMessage: "你的消息",
      agentMessage: "智能体消息",
      ...
      terminal: "终端输出",
      noOutput: "没有输出",
      unknownPart: "不支持的活动：%{type}",
    },
    steering: {
      title: "继续指示",
      placeholder: "发送后续指示……",
      send: "发送后续指示",
      offline: "重新联网后才能发送后续指示。",
      reconnecting: "正在重新连接会话……",
      pending: "正在等待当前轮次完成……",
      unknown: "该轮次结果尚不确定。请先刷新持久化对话，再决定是否重新发送。",
    },
    decision: {
      title: "智能体需要你的输入",
      turnExpires: "此请求将在 %{time} 过期。",
      onceOnly: "仅批准本次操作，不会授予持久权限。",
      decline: "拒绝",
      submit: "提交回复",
      openLink: "打开安全链接",
      complete: "我已完成",
      invalid: "请填写所有必填项并提供有效值。",
      changed: "该请求已变化或已被回答。请刷新后重新检查。",
      unsupported: "移动端无法安全处理此请求。",
      sensitiveUnsupported: "敏感信息必须通过安全外部链接输入，不能写入对话。",
    },
  },
  auth: {
