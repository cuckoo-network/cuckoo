...
- `scripts/auth-bootstrap-client.sh` has provisioned the public `bex-mobile` client with the exact `https://dashboard.bex.co/oauth2redirect` universal/app link.
...
6. **Invalid callback:** open malformed `https://dashboard.bex.co/oauth2redirect/...` and an unclaimed custom-scheme callback; confirm neither authenticates and no resource screen opens.
