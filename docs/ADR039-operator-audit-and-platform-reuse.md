...
This ADR supplements [ADR003](ADR003-control-plane.md), [ADR018](ADR018-render-parity.md), [ADR022](ADR022-tenant-isolation.md), [ADR028](ADR028-security-review.md), and [ADR034](ADR034-scalable-build-pipeline.md). O-01 and O-02 were closed by w2/m59 on 2026-07-19; ADR022 now records the resulting verified build/admission boundary. O-03 through O-10 remain open remediation units.
...
### O-03 through O-06: reconciliation correctness
