...
4. **`usage_threshold` is policy-selectable but no producer emits it** (the w8/001 producer is the referenced owner; w11/m5 explicitly declined to duplicate it).
