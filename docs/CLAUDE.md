...
- [ADR087-platform-observability-ui.md](ADR087-platform-observability-ui.md) — Grafana at `obs.bex.co` (GitOps, monitoring ns), OIDC via Hydra, ops-workspace gate at consent
