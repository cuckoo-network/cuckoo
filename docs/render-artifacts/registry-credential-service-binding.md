...
| MCP | `create_web_service` / `create_cron_job` argument for either source context | `update_service(registryCredentialId:)` (w1/m71 folded `set_registry_credential` into it) |
