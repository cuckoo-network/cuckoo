...
- **A second panel goes on the RIGHT.** Devin's session view pairs the chat column with a right-hand workspace panel (Progress/Changes/PR tabs); bex's equivalent is the w3/m44 evidence/PR panel. Extra surface belongs there, not in a second left rail.
