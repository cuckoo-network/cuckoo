...
**Status:** Proposed · deep-research 2026-08-01; D3 amended same day (in-sandbox AI SDK session driver). Not yet scheduled. Engages the `.pm/DO_NOT_DO.md` "Hosted Claude Code inside sandbox" deferral — adopting this ADR re-opens that item as a phased product.
