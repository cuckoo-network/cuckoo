...
- **Pre-GA cost check**: authenticated `GET https://api.hetzner.cloud/v1/pricing` for `volume.price_per_gb_month` (the €0.0440-vs-€0.0572 question) recorded in the closeout note.
