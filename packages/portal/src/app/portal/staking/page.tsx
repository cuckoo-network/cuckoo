...
const cfg = {
  ...
  description: "Stake WCAI (Wrapped CAI) to secure the decentralized AI Platform and get 4~12% yearly. Cuckoo Portal is the management portal for Cuckoo decentralized AI platform",
};
