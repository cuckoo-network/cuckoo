...
function selectPost(dataTrendingPost: SocialPostsQuery | undefined) {
  return dataTrendingPost?.socialPosts.edges[0].node;
}
...
export function PostDetails({
  ...
  // const {fetchTrendingPost, loadingTrendingPost, dataTrendingPost} = useSocialPost();
      ...
      <DialogContent className="max-w-4xl">
        <div className="relative grid w-full min-w-0 grid-cols-1 gap-4 break-words px-4 md:grid-cols-2 md:gap-8 false">
          <div className="flex justify-between md:hidden ml-9">
            ...
            <button className="ml-6 flex h-10 items-center justify-center gap-1 rounded-xl px-3 font-bold text-darkText bg-primaryBtn">
              Follow
            </button>
          </div>
          ...
          <div>
            <div className="mb-6 hidden items-center justify-between gap-4 md:flex">
              ...
              <div className="hidden items-center gap-3">
                ...
                <button className="flex h-11 items-center gap-1 rounded-xl px-3 font-bold text-darkText bg-primaryBtn">
                  Follow
                </button>
              </div>
            </div>
            <div className="mb-4 w-full leading-relaxed text-primaryText">
              <div className="mb-6 flex items-center justify-between">
                <div className="flex h-10 w-10 items-center justify-center rounded-md bg-tertiaryBg md:hidden">
                  <div
                    className="relative flex cursor-pointer items-center justify-center space-x-1 leading-tight"
                    data-headlessui-state=""
                  >
                  ...
                  <div className="grow">
                    <div className="flex justify-between text-primaryText">
                      <div className="grow text-sm leading-tight">
                        ...
                        <p>
                          Me duele cómo creador y consumidor. Sobretodo dando
                          uso a la pagina desde casi sus inicios cuando ni la
                          taberna existia. Quisiera seguirme manteniendo en
                          espera a una solución o quizas un reemplazo...
                        </p>
                      </div>
                      <div className="flex items-start">
                        <div className="ml-3 flex items-center gap-2 text-center">
