...
export type Mutation = {
  ...
  interactWithPost: Scalars["Boolean"]["output"];
  login: LoginResponse;
...
export type RequestAirdropMutation = {
  __typename?: "Mutation";
...
export type SendTransactionMutation = {
  __typename?: "Mutation";
  sendTransaction: { __typename?: "TransactionResponse"; hash?: string | null };
};

export type AirdropStatsQueryVariables = Exact<{ [key: string]: never }>;

export type AirdropStatsQuery = {
  __typename?: "Query";
  airdropStats: {
    __typename?: "AirdropStats";
    totalRewards: number;
    recentAirdrops: Array<{
      __typename?: "AirdropHistoryItem";
      id: string;
      type: AirdropType;
      rewards: string;
...
export type WalletAccountQuery = {
  __typename?: "Query";
  walletAccount: {
    __typename?: "WalletAccountResponse";
    address: string;
...
export type SocialPostsQueryVariables = Exact<{
  after?: InputMaybe<Scalars["String"]["input"]>;
  first?: InputMaybe<Scalars["Float"]["input"]>;
  id?: InputMaybe<Scalars["ID"]["input"]>;
}>;
...
export type InteractWithPostMutation = {
  __typename?: "Mutation";
  interactWithPost: boolean;
};
...
export type CreatePhotoMediaMutation = {
  __typename?: "Mutation";
  createPhotoMedia: {
    __typename?: "PhotoMedia2";
    id: string;
...
export type SetPhotoUploadedMutation = {
  __typename?: "Mutation";
  setPhotoUploaded: boolean;
};
...
export type CreateTextToImageMutation = {
  __typename?: "Mutation";
  createTextToImage: {
    __typename?: "TextToImageHistoryItem";
    id: string;
...
export type TextToImageHistoryQuery = {
  __typename?: "Query";
  textToImageHistory: {
    __typename?: "TextToImageHistoryItemConnection";
    pageInfo: {
...
export type RequestTokensMutation = {
  __typename?: "Mutation";
  requestTokens: {
    __typename?: "TransferHashes";
    erc20TokenTransferHash: string;
    nativeTokenTransferHash: string;
  };
};

export type MinersQueryVariables = Exact<{ [key: string]: never }>;

export type MinersQuery = {
  __typename?: "Query";
  miners: Array<{
    __typename?: "MinerInfo";
    type: string;
...
export const RequestAirdropDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RequestAirdrop" },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "RequestAirdropInput" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "erc4361Message" },
                },
...
>;
export const SendTransactionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SendTransaction" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "TransactionRequest" },
            },
          },
        },
      ],
...
>;
export const AirdropStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AirdropStats" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "recentAirdrops" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
...
} as unknown as DocumentNode<AirdropStatsQuery, AirdropStatsQueryVariables>;
export const AirdropHistoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AirdropHistory" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<AirdropHistoryQuery, AirdropHistoryQueryVariables>;
export const WalletAccountDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "WalletAccount" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<WalletAccountQuery, WalletAccountQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateSocialPostInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "createSocialPost" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "data" },
...
export const SocialPostsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SocialPosts" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "postState" },
                            },
                            {
                              kind: "Field",
...
} as unknown as DocumentNode<SocialPostsQuery, SocialPostsQueryVariables>;
export const InteractWithPostDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "InteractWithPost" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "InteractWithPostInput" },
            },
          },
        },
      ],
  ...
  InteractWithPostMutationVariables
>;
export const CreatePhotoMediaDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "PhotoMediaInput2" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "readUrl" } },
                { kind: "Field", name: { kind: "Name", value: "writeUrl" } },
                { kind: "Field", name: { kind: "Name", value: "postId" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "textToImageId" },
                },
              ],
            },
          },
  ...
  CreatePhotoMediaMutation,
  CreatePhotoMediaMutationVariables
>;
export const SetPhotoUploadedDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SetPhotoUploaded" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "setPhotoUploadedId" },
          },
          type: {
            kind: "NonNullType",
            type: {
  ...
  SetPhotoUploadedMutationVariables
>;
export const CreateTextToImageDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateTextToImage" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "data" } },
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "TextToImageInput" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "samplingSteps" },
                },
                { kind: "Field", name: { kind: "Name", value: "width" } },
                { kind: "Field", name: { kind: "Name", value: "height" } },
                { kind: "Field", name: { kind: "Name", value: "createdAt" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "readUrl" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "writeUrl" },
                      },
                      {
                        kind: "Field",
...
export const RequestTokensDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RequestTokens" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "erc20TokenTransferHash" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "nativeTokenTransferHash" },
                },
              ],
            },
          },
  ...
  RequestTokensMutation,
  RequestTokensMutationVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "gpuModels" } },
                { kind: "Field", name: { kind: "Name", value: "cpuCount" } },
                { kind: "Field", name: { kind: "Name", value: "ramUsed" } },
...
} as unknown as DocumentNode<MinersQuery, MinersQueryVariables>;
