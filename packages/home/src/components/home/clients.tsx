            ...
            <div
              ...
              <style>{`
                ...
                [data-theme='light'] .client-logo {
                  filter: grayscale(100%) brightness(29%);
                }
              `}</style>
              <div className="swiper-wrapper !ease-linear select-none items-center">
                {/* Carousel items */}
                <div className="swiper-slide !w-auto">
                  <Client01 className="client-logo" width={110} height={21}/>
                </div>
                <div className="swiper-slide !w-auto">
                  <Client02 className="client-logo" alt="Client 02" width={200} height={36}/>
                </div>
                <div className="swiper-slide !w-auto">
                  <Client03
                    className="client-logo mt-1"
                    alt="Client 03"
                    width={107}
                    height={33}
                  />
                ...
                <div className="swiper-slide !w-auto">
                  <Client04 className="client-logo" alt="Client 04" width={85} height={36}/>
                </div>
                <div className="swiper-slide !w-auto">
                  <img
                ...
                <div className="swiper-slide !w-auto">
                  <Client06 className="client-logo" alt="Client 06" width={78} height={34}/>
                </div>
                <div className="swiper-slide !w-auto">
                  <img
                ...
                <div className="swiper-slide !w-auto">
                  <Client08 className="client-logo" alt="Client 08" width={98} height={26}/>
                </div>
                <div className="swiper-slide !w-auto">
                  <Client09
                    className="client-logo mt-2"
                    alt="Client 09"
                    width={92}
                    height={28}
                  />
