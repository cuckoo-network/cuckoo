...
- Đội ngũ của chúng tôi, do các cựu sinh viên Yale và Harvard dẫn dắt, bao gồm các thành viên sáng lập của các dự án blockchain hàng đầu và các chuyên gia trong lĩnh vực học máy.
- Chúng tôi hoạt động tại giao điểm giữa tiền mã hóa, các mô hình AI, và nền kinh tế chia sẻ.
- Chúng tôi tập trung vào suy luận đa chế độ và blockchain, giảm chi phí suy luận và tích hợp tokenomics với AI tạo sinh.
