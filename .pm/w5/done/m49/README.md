...
- **Goal linkage:** ADR008 pillar 1 / Render compatibility and the reliable service-lifecycle goals in `docs/ADR004-app-deployment.md`; this keeps Render's official CLI as bex's fifth surface without building or forking a CLI.
