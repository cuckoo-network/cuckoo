# w5 · m68 — Intent-preload data prefetch: kill the navigation fetch waterfall

**Worker:** worker5 **Goal:** make `defaultPreload: "intent"` actually prefetch a route's primary data on hover, so covered pages render with data instead of a post-mount skeleton **Status:** todo
