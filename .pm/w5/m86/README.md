# w5 · m86 — Platform observability UI: Grafana at obs.bex.co (ADR087)
...
- **t010 closeout blocked on:** `/ship` (repo rule: no commit without it), then post-merge Argo CD rollout + live `obs.bex.co` sign-in check, then record here and close.

## Source + Goal linkage

- **Source:** [docs/ADR087-platform-observability-ui.md](../../../docs/ADR087-platform-observability-ui.md) (accepted 2026-09-07), from the platform-monitoring discussion of 2026-09-07 (Grafana placement → hostname → AuthN/AuthZ decisions).
