...
- [ ] **m5** — Secret-file list pagination (7 tasks) ← promotes `005` 2026-07-15 (Render gives the route the env-vars `cursor`/`limit` contract; bex accepts and ignores the params, GraphQL/MCP/dashboard unpaged — the w9/m10 stable-name cursor pattern on its sibling route)
