...
- [ ] **m4** — cli-compat verify completeness: guard every fixed RC (6 tasks) ← from `/pm-brainstorm` round 9, 2026-07-15 (the m2 checklist's own "not yet covered by this script" residual: postgres lifecycle, services CRUD, deploys, logs, environments, logout legs — so RC2/RC7–RC12 can't silently regress)
