...
**Worker:** worker9 **Goal:** replace the bare centered spinner on top-level list routes with content-shaped skeletons, and rationalize the per-route pending config the persistent-shell ship made partly redundant **Status:** todo
