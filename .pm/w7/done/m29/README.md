...
**Worker:** worker7 **Goal:** Every platform backup chain (etcd, OpenBao, bex-db) is proven restorable by an actually-executed drill, with corrected runbooks and drill records in ADR031. **Status:** done — **DONE**

## Tasks (in order)

| id   | title                                                       | est | depends_on       | status      |
| ---- | ----------------------------------------------------------- | --- | ---------------- | ----------- |
| t001 | etcd snapshot → restore drill (mock cluster)                | 60m | —                | — **DONE**  |
| t002 | OpenBao Raft snapshot → restore drill                       | 45m | —                | — **DONE**  |
| t003 | bex-db barman PITR → new-cluster drill                      | 60m | —                | — **DONE**  |
| t004 | Record drill outcomes + re-drill cadence; fix runbook steps | 30m | t001, t002, t003 | — **DONE**  |
...
**Verified 2026-07-14:** All three drills passed. Runbooks corrected. Drill records in ADR031. CI guard added.
