...
- [ ] **m6** — Phase-1 agent mission control (9 tasks) ← from ADR048 M2 + ADR047 phase 1 — **t001–t008 implemented + verified + shipped/deployed to prod 2026-08-08 (`3bbe956d`)**; t009 closeout hard-blocked on the live phone→draft-PR proof + physical-device push verification (also the w3/m41 + w11/m5 gates), unavailable in a dev environment, so m6 stays open
