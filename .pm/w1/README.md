...
- [ ] **m39** — Dependency security: clear the alert spike (7 tasks; t001–t003 done locally, live confirmation awaits publication) ← from `/pm-brainstorm` round 10, 2026-07-15 (Dependabot 4 → 18 alerts initially, then 31 as duplicate `x/crypto` advisories attached to the operator manifest; the m23/m30 triage pattern at milestone size)
