...
| t008 | Closeout                                                                                         | 10m | t007 — **BLOCKED**: needs the logged-in prod live-substrate walk (Playwright can't auth); code + local render verified, m43 stream proven by its own E2E |
