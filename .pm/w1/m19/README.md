...
| t005 | Terraform: label-selector port firewall (public ingress = 80/443/6443/22 only)                             | 30m | —                   |
| t006 | Execute: teardown → rebuild via CI → GitOps converge → restore OpenBao + CNPG data                         | 90m | t001,t002,t003,t004,t005 |
| t007 | Pivot: `clusterctl move` to self-managed · in-cluster autoscaler · destroy `bex-infra` node                | 45m | t006                |
| t008 | External pointers: DNS → new Traefik LB IP · rotate CI kubeconfig secrets                                  | 30m | t006                |
