...
**Worker:** worker1
**Goal:** Close the deliberate demo shortcuts so the cluster is more than a demo: firewall the API, pin the operator image, encrypt secrets + node traffic, and get a stable LB IP on a private network.
**Status:** todo
