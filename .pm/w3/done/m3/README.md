...
- **Goal linkage:** `GOAL.md` #2 ("basic obs for operation") — the human-facing half of the metrics obs slice; `docs/vision.md` Render-parity dashboard pillar (w5). Proves the dashboard→bex-api GraphQL path end-to-end (`docs/bex-api.md` "Render dashboard compatible" was built exactly for this client).
