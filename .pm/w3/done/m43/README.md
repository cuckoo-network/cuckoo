...
| t009 | Test coverage                                                                                  | 60m | t007 — **DONE** (unit + real-Postgres + driver; live production verifier passed 2026-08-04 and 2026-08-18) |
...
- **Why now:** at materialization, m41 was implementation-complete pending only live E2E, m42 had removed the hibernation blocker, and the D9 decision had frozen the contract. The carried m41 gate later passed and is closed. Render parity task included: the attach-ticket verb and stream contract are tenant-facing across REST/GraphQL/MCP (m39 precedent; Render has no equivalent — bex-extension row).
