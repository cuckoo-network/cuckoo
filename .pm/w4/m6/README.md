...
| t007 | Docs: `docs/bex-api.md` + `docs/secrets.md` product section + env tables                                       | 20m | t006       | — **DONE**    |
