...
- [ ] **m19** — Duplicate service names: workspace-unique names + globally-unique subdomains, Render-consistent (11 tasks) ← user request 2026-07-12 (`/pm`); fixes the cross-tenant name-existence 403 leak + conflict-500 on the way (tenancy-correct naming = w4's multi-tenant-security mandate)
