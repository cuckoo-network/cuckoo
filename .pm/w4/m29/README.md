...
| ---- | ------------------------------------------------------------------------------ | --- | ---------- |
| t001 | Idempotent one-shot normalization: bare strings → `{cidr}` (RC5 backfill precedent) | 45m | —          |
| t002 | Verify + record zero string-shaped CRs remain (prod + local evidence)          | 20m | t001       |
