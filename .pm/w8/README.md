...
- [ ] **m20** — Blueprint grouping hardening: transactional writes, quota, audit, disconnect reclaim (8 tasks) ← promotes `w1/049` #5 residuals 2026-08-16 (security-scan round 7 deferred register; fix-shape precedent `w7/done/m72/t004`); sequenced after m19 in the same workstream since both touch `blueprint.go`
