...
- **Goal linkage:** tenant safety on the blueprint surface (the ADR045→ADR072 lineage's recurring theme: shared sinks resolved by name) + Render parity ledger honesty.
