...
- **Goal linkage:** tenancy + enforced authz (the Render-alternative core) and the ADR028→ADR072 security-review lineage — this closes a triaged register item rather than leaving it to be re-reported by scan round 8.
