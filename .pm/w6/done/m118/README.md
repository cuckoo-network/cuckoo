...
**Worker:** worker6 **Goal:** free-plan replica policy is decided and enforced — or deliberately left open with the UI no longer claiming those instances are billed **Status:** done — closed 2026-08-29: live over-cap scale refused identically on REST/GraphQL/MCP ("the free plan is limited to 1 instance(s)…"), dashboard slider capped at 1 with the free copy and no "billed accordingly", valid scale agrees with /instances; see done/t005.md
