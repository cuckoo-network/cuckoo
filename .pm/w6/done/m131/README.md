...
| t005 | Render parity sweep (REST/GraphQL/MCP/dashboard) | 30m | t002, t003, t009 | — **DONE** — full authenticated sweep 2026-09-05: all four surfaces agree + narrow |
| t006 | Simplify                                                                                | 20m | t005             | — **DONE**                                                                                    |
| t007 | Test coverage                                                                           | 30m | t005             | — **DONE** — 3 backend tests + 3 dashboard tests                                              |
| t008 | Closeout                                                                                | 10m | t004, t007       | — **DONE** — every DoD bullet live-verified 2026-09-05; `logs-verify.sh` PASS on prod         |
