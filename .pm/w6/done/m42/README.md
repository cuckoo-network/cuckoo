...
| t008 | Render parity: widened 402 + auth flows consistent across REST/GraphQL/MCP/dashboard — **DONE** | 30m | t007, t012, t013                   |
| t009 | Simplify: `/simplify` over the changed code — **DONE**                                   | 30m | t008                               |
| t010 | Test coverage: gate-mode, admission, and auth-flow regressions — **DONE**                | 45m | t008                               |
