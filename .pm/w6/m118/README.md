...
**Worker:** worker6 **Goal:** free-plan replica policy is decided and enforced — or deliberately left open with the UI no longer claiming those instances are billed **Status:** todo
