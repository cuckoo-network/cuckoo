...
- [ ] **m14** — Registry credentials: private external image registries (8 tasks) ← from `/pm-brainstorm more milestones to work on` 2026-07-13 (`docs/ADR018-render-parity.md` "Registry credentials" row, verified live that Render genuinely supports this — Docker Hub/GHCR/GitLab/Google Artifact Registry + a real Update Registry Credential API); mirrors the `w2/m8` GitHub-App-credential → materialized-Secret pattern
