...
- **Goal linkage:** pillar 5 (cloud coding-agent sessions, ADR047) — security hardening of the one credential ADR047 D7 knowingly left inside the sandbox; continues the ADR028→ADR060 security lineage's credential-confinement theme (Git token D2, exec/attach tickets).
