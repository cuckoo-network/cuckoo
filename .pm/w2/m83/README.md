...
**Worker:** worker2 **Goal:** one way to attach a repository and one Recents surface on `/agents`, instead of the three repo affordances and two session lists the page accreted across four milestones **Status:** todo

## Tasks (in order)

| id   | title                                                            | est | depends_on   |
| ---- | ---------------------------------------------------------------- | --- | ------------ |
| t001 | Collapse the two repo-attach controls into one affordance         | 45m | —            |
| t002 | Resolve the duplicate Recents between the rail and the page       | 45m | —            |
| t003 | Re-check the `/agents` skeletons against the simplified ready state | 30m | t001, t002 |
| t004 | Render parity — `/agents` surface consistency                     | 20m | t001, t002, t003 |
| t005 | Simplify the code this milestone changed                          | 30m | t004         |
| t006 | Test coverage for the consolidated controls                       | 30m | t004         |
