...
| bex-api | `BEX_DASHBOARD_URL` | trusted dashboard origin for GitHub install-callback success/error redirects and workspace-invite links (e.g. `https://dashboard.bex.co`); unset ⇒ callbacks return JSON and invite email has no deep link |
