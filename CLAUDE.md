...
| operator | `BEX_BUILD_NAMESPACE` | namespace the in-cluster BuildKit Jobs and kpack Images/builds run in (docs/ADR004-deployment.md); unset ⇒ the App's own namespace |
