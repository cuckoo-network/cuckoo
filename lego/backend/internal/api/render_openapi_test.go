...
func TestRenderRouteIntersectionInventory(t *testing.T) {
	...
	const expected = "add-or-update-secret-file,autoscale-service,cancel-cron-job-run,cancel-deploy,cancel-job,create-custom-domain,create-deploy,create-env-group,create-environment,create-key-value,create-postgres,create-postgres-export,create-project,create-registry-credential,create-service,create-webhook,delete-autoscaling-config,delete-custom-domain,delete-env-group,delete-env-group-env-var,delete-env-group-secret-file,delete-env-var,delete-environment,delete-key-value,delete-postgres,delete-project,delete-registry-credential,delete-secret-file,delete-service,delete-webhook,failover-postgres,get-bandwidth,get-cpu,get-cpu-target,get-disk-capacity,get-env-vars-for-service,get-http-latency,get-http-requests,get-instance-count,get-memory,get-memory-target,get-replication-lag,get-user,link-service-to-env-group,list-blueprints,list-custom-domains,list-deploys,list-env-groups,list-environments,list-events,list-headers,list-instances,list-job,list-key-value,list-logs,list-logs-values,list-owners,list-postgres,list-postgres-export,list-projects,list-registry-credentials,list-routes,list-secret-files-for-service,list-services,list-webhook-events,list-webhooks,listWorkflows,patch-service-notification-overrides,post-job,put-routes,refresh-custom-domain,restart-postgres,restart-service,resume-key-value,resume-postgres,resume-service,retrieve-blueprint,retrieve-custom-domain,retrieve-deploy,retrieve-env-group,retrieve-env-group-env-var,retrieve-env-group-secret-file,retrieve-env-var,retrieve-environment,retrieve-job,retrieve-key-value,retrieve-key-value-connection-info,retrieve-owner,retrieve-owner-members,retrieve-postgres,retrieve-postgres-connection-info,retrieve-project,retrieve-registry-credential,retrieve-secret-file,retrieve-service,retrieve-service-notification-overrides,retrieve-webhook,rollback-deploy,run-cron-job,scale-service,subscribe-logs,suspend-key-value,suspend-postgres,suspend-service,unlink-service-from-env-group,update-env-group,update-env-group-env-var,update-env-group-secret-file,update-env-var,update-env-vars-for-service,update-environment,update-headers,update-key-value,update-postgres,update-project,update-registry-credential,update-service,update-webhook,validate-blueprint"
