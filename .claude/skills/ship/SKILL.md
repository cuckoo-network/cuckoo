...
name: ship
description: >-
  Safely bring main up to date, commit intended pending changes, and push to origin/main. Use when the user explicitly asks to ship the current main branch or invokes the repository's ship workflow. For substantial code changes, monitor CI and production deployment until green.
